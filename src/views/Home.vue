  ...
  <div class="home">
    <b-container fluid>
      <b-row align="center" class="header">
            ...
            <b-container fluid>
              <b-row>
                ...
                <b-col cols="12">
                  <a href="/history">
                    <img
                      src="../assets/img-nav/clipboard.png"
                      alt="History"
                      class="my-5"
                    />
                  </a>
        ...
        <b-col xl="7" lg="7" cols="8" class="foodItems align-self-center py-4"
          >Food Items</b-col
        >
                ...
                <b-col cols="3" class="text-right">
                  <b-dropdown :text="sortText">
                    <b-dropdown-group header="Name">
                      <b-dropdown-item-button @click="sortAscByName()"
                        >A-Z</b-dropdown-item-button
                      >
                      <b-dropdown-item-button @click="sortDescByName()"
                        >Z-A</b-dropdown-item-button
                      >
                    </b-dropdown-group>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-group header="Price">
                      <b-dropdown-item-button @click="sortAscByPrice()"
                        >Highest</b-dropdown-item-button
                      >
                      <b-dropdown-item-button @click="sortDescByPrice()"
                      ...
                      <b-row>
                        <b-col cols="4" align="center">
                          <span v-if="!checklistPlusMinus(item)">
                            <i
                              class="fas fa-plus-circle icon-product"
    ...
    <b-modal hide-footer ref="modal-confirm" title="Are You Sure ?">
      <div class="text-right">
        ...
        <b-button @click="postOrder()" class="ml-2" variant="success"
          >OK</b-button
        >
      </div>
    </b-modal>
